...
{
    public partial class Form_Bike_DeleteConfirm : Form
    {
        RentalShop m_RentalShop;
        npgSQL npgsql = new npgSQL();
        Bike m_Bike;
        public Form_Bike_DeleteConfirm(Bike bike, RentalShop rentalShop)
        {
            InitializeComponent();
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            ...
            {
                npgsql.DBConnect();
                sql = @"DELETE FROM ""Bike"" WHERE code = '" + m_Bike.Code + "'";
